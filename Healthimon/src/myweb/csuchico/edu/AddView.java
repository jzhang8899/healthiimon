...
public class AddView extends Activity implements OnClickListener {
	...
	private TextView bicepcurls,exercisename,tricepextensions,shoulderpress,tricepdips,shoulderextensions,pushups,benchpress,dumbbellcurls,pullups,chinups,seatedrows,shrugs,
					 situps,crunches,sqats,legextensions,legcurls,running,swimming,biking,stairs;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dumbbellcurls=(TextView)findViewById(R.id.dumbbellcurls);
		dumbbellcurls.setOnClickListener(this);
        ...
        sqats=(TextView)findViewById(R.id.sqats);
		sqats.setOnClickListener(this);
        ...
        stairs=(TextView)findViewById(R.id.stairs);
		stairs.setOnClickListener(this);
    ...
    public void onClick(View v) {
    	...
    	switch (v.getId())
    	{
    		case R.id.add_calorie_intake:  exercisename="Calorie Intake";
    									   ...
    									   exerciseAttr2="Number of Protions";
    									   exerciseNo=1;
    									   break;
           ///For non Touchable views like Arms Abs etc  									   
    		...
    		case R.id.benchpress:		   exercisename="Bench Press";
    									   ...
    									   exerciseNo=8;
    									   break;   
    		case R.id.dumbbellcurls:	   exercisename="Dumb-Bell Flys";
			                               exerciseAttr1="Weight";
			                               exerciseAttr2="Reps";
			                               exerciseNo=9;
			                               break;   
    		...
    		case R.id.crunches:			   exercisename="Crunches";
			   							   ...
			   							   exerciseNo=15;
			   							   break;   
    		case R.id.sqats:			   exercisename="Squats";
			   							   exerciseAttr1="Weight";
			   							   exerciseAttr2="Reps";
			   							   exerciseNo=16;
			   							   break;   
    		...
    		case R.id.biking:			   exercisename="Biking";
    									   ...
    									   exerciseNo=21;
    									   break;   
    		case R.id.stairs:			   exercisename="Stairs";
			   							   exerciseAttr1="Distance";
			   							   exerciseAttr2="Time";
			   							   exerciseNo=22;
			   							   break;   
